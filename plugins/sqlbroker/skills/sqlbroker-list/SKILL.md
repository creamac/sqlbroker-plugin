---
name: sqlbroker-list
description: List all configured SQL connection aliases on this host. Triggers on "/sqlbroker-list", "/sqlbroker:list", "list aliases", "show all sqlbroker connections", "what databases are configured".
---
